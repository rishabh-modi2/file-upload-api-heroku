...
cloudinary.config({
  cloud_name:process.env.CLOUD_NAME || 'dqdi8iixx',
  api_key:process.env.API_KEY || '224689595751776',
  api_secret:process.env.API_SECRET || 'UYPfns8GI0_OBpgr6-UeCowYJiY'
})
...
const url = process.env.DB || `mongodb+srv://Animesh:723126@cluster0.oxxkg.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
